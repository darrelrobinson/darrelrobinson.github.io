...
## [A Stock Dashboard App](https://darrelrobinson.shinyapps.io/stock_dashboard/)

This is a very simple dashboard I use to follow stock returns.  The app is written with RShiny and the data is collected using the quantmod package.  The code can be found at my GitHub profile.
