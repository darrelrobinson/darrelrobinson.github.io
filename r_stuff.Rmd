...
This is a very simple algorithm and dashboard I use to follow stocks.  The "Buy" and "Sell" signals are based on RSI and Bollinger Bands and can be used as entry and exit points.  The app is written with RShiny and the data is collected and visualized using the quantmod package.  The code can be found at my <a href="https://github.com/darrelrobinson" target="_blank">GitHub profile</a>.
